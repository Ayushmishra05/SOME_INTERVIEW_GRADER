...
def analyze_audio_metrics(audio_path, transcription_json_path, output_json_path, segment_duration_ms=5000):
    ...
    audio_metric = {
        ...
        "speaking_speed": round(words_per_minute, 2),
